...
<html>
    ...
    <body>
          <h2>
                <fmt:message key="title.copySchedule" />
            </h2>
        <form action="${pageContext.request.contextPath}/controller/copySchedule"
              method=post>
            
            <input type="button"   name="getScheduledProgramButton" id="getScheduledProgramButton"  value="Click to Copy a scheduled Program"/>
        </form>
        <form name="testfrm" action="${pageContext.request.contextPath}/controller/copySchedule"
              method=post>
