...
<html>
    <head>
        ...
        <script>
            ...
            var url = "${pageContext.request.contextPath}/controller/searchrp";
                $("#radioProgramDialog").dialog({
                    title: 'Review Select radio Program',
                    autoOpen: false,
                    resizable: false,
                    height: 300,
                    width: 600,
                    ...
                    close: function (event, ui) {
                        $("#radioProgramDialog").dialog().dialog('close');
                    }
                });

                $("#radioProgramDialog").dialog('open');
                return false;
            }
    ...
    <body>
          <h2>
                <fmt:message key="title.modifySchedule" />
            </h2>
<!--        <form action="${pageContext.request.contextPath}/controller/deleteSchedule"
        ...
        <form name="testfrm" action="${pageContext.request.contextPath}/controller/modifySchedule"
              method=post>
                    ...
                    <td>
                        <table>
                            ...
                            <tr>
                                ...
                                <td>
                                    <img class="icon" src="${pageContext.request.contextPath}/img/search.png" id="searchrp" onclick="openDialog();"/>
                            ...
                            <tr>
                                ...
                                <td>
                                    <img class="icon" src="${pageContext.request.contextPath}/img/user_search.png" id="userSearchPre"/>
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <img class="icon" src="${pageContext.request.contextPath}/img/user_search.png" id="userSearchPro"/>
                                </td>
